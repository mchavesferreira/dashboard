...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Campus Inteligente</title>
...
<body>
  <nav class="navbar navbar-expand-lg d-none d-sm-block" style="background-color:#088A29; color: #fff">
    <a class="navbar-brand" href="#" style="text-decoration: none;color: #fff">
    <img src="https://ctd.ifsp.edu.br/images/IFSP-CTD2.png" alt="Instituto Federal de São Paulo"  width="44px" height="70px"> Dashboard IFSP Catanduva</a>
          ...
          <ul class="nav flex-column"  style="padding-top: 20px">
            <li class="nav-item">
              <a class="nav-link active" href="?pagina" style="color:#000;text-decoration: none">
                ...
                <i class="fas fa-tachometer-alt"></i>&nbsp;Hidrômetro <span class="sr-only">(atual)</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="?pagina=clientes" style="color:#000;text-decoration: none">
                ...
                <i class="fas fa-solar-panel"></i>&nbsp;Painel Solar
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="?pagina=vendas" style="color:#000;text-decoration: none">

                <i class="fas fa-dharmachakra"></i>&nbsp;Ar condicionado
              </a>
            </li>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        if(isset($_GET['pagina'])) {
          ...
          switch ($_GET['pagina']) {
            ...
            include 'graficos/historico.php';
            break;
  ...
  <div class="d-block d-sm-none">
    <nav class="navbar fixed-bottom navbar-light bg-light">
      <a class="navbar-brand" href="#">Dashboard IFSP Catanduva</a>
